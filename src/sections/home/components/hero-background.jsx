    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          [stylesMode.dark]: {
            backgroundImage: `url('${CONFIG.assetsDir}/assets/images/home/img1.webp'), linear-gradient(180deg, ${theme.vars.palette.background.default} 12%, ${varAlpha(theme.vars.palette.background.defaultChannel, 0.96)} 50%, ${theme.vars.palette.background.default} 88%), url('${CONFIG.assetsDir}/assets/background/background-3.webp')`,
          },
        }}
      />
    </Box>
