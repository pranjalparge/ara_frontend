...
import { useGetFaqMutation } from '../../redux/slices/customer/auth';
...
export function AboutFAQs({ sx, ...other }) {
  const [getFaq, { data, isLoading, isSuccess }] = useGetFaqMutation();
    ...
    >
      ...
      <m.div variants={varFade().in}>
        <Button
          color="inherit"
          variant="contained"
          href="mailto:tumchadabba@gmail.com?subject=[Feedback] from Customer"
